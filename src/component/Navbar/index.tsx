...
const Navbar = () => {
    ...
    return (
        <>
            ...
            >
                <div className="max-width py-6 flex items-center justify-between gap-4 z-[80] relative">
                    <Link href={"/"} className="flex items-center gap-2">
                        <Image
                            ...
                            height={35}
                        />
                        <h3 className="text-2xl font-medium sm:text-2xl md:text-4xl sm:font-semibold">
                            Fresh Harvests
                        </h3>
                    </Link>
                ...
                >
                    <ul className="p-4 bg-white shadow-2xl">
                        ...
                        <li>
                            <button
                                className="flex justify-center gap-2 px-5 py-2.5 hover:bg-slate-100 rounded-sm active:scale-95 transition-[scale] duration-300 w-full"
                                onClick={() => {
                                    setNavOpened(false);
                                    setAuthType("login");
                                }}
            ...
            <Authorization type={authType} setType={setAuthType} />
        </>
    );
};
